...
// 6 hero image pieces with unique IDs
type PieceId =
  | "rect1"
  | "rect2"
  | "rect3"
...
export default function PuzzleArena() {
  // Ref to the container div to calculate offsets, since the arena is not full screen
  const containerRef = useRef<HTMLDivElement | null>(null);

  // Store positions of each piece by their ID (initially placed in a grid)
